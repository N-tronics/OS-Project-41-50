...
const team = [
  {
    ...
    modules: ['CPU Scheduling', 'Virtual Memory Simulator'],
    color: '#06b6d4',
    initials: 'RK',
  },
  {
    name: 'Ashwin S',
    github: 'ashwin23761',
    modules: ['System Calls', 'Inter-Process Communication'],
    color: '#14b8a6',
    initials: 'AS',
  },
  {
    name: 'Rajsimha',
    github: 'raju-anna',
    modules: ['Disk Scheduling', 'I/O Buffering'],
    color: '#f59e0b',
    initials: 'RS',
  },
  {
    name: 'Abinaya',
    github: 'abinaya-nitk',
    modules: ['Page Replacement', 'TLB Simulator'],
    color: '#22c55e',
    initials: 'AB',
  },
  {
    ...
    modules: ['File Allocation', 'File System Journaling'],
    color: '#a78bfa',
    initials: 'PS',
  },
  {
    ...
    github: 'N-tronics',
    modules: ['Process Synchronization', 'Semaphore Visualizer'],
    color: '#fb923c',
    initials: 'NB',
  },
  {
    ...
    modules: ['Contiguous Memory Allocation (MFT)', 'Memory Fragmentation'],
    color: '#f472b6',
    initials: 'MO',
  },
  {
  ...
  },
  {
    name: 'Shivkumar R',
    github: 'Shiv9936A',
    modules: ['MVT Memory Management', 'Segmentation Visualizer'],
    color: '#38bdf8',
    initials: 'SR',
  },
  {
    ...
    modules: ['File System', 'Inode Structure Viewer'],
    color: '#4ade80',
    initials: 'PB',
  },
]
